...
const 设置等级标题 = levels.children[0];
...
const 保存图像 = _=>{
    ...
    地址变图像元素(数据地址,图=>{
        ...
        画板.toBlob(元素数据=>{
            ...
            mobid.style.display = '';
            mobid.querySelector('img').src = 地址;
...
添加事件监控(mobid.querySelector('a'),'click',_=>{
